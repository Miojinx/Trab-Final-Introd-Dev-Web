                ...
                <div class="col-sm-4 offset-3">
                    ...
                    <form action="/TrabalhoFinal-ErikEGabriel/vendedor/VendasController" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <label for="id_vendedor" class="form-label" >ID do Vendedor</label>
                            <input type="text" name="id_vendedor" <%= acao.equals("Excluir") ? "Readonly" : ""%> value="<%=venda.getId_vendedor()%>" class="form-control">
                        </div>
                        <div>
